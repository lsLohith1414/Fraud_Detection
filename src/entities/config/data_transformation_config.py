...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.transformed_data_dir = os.path.join(
            self.data_transformation_dir, TRANSFORMED_DATA_DIR
        )

        self.transformed_train_file_path = os.path.join(
            self.transformed_data_dir, TRANSFORMED_TRAIN_FILE_NAME
        )  #

        self.transformed_test_file_path = os.path.join(
            self.transformed_data_dir, TRANSFORMED_TEST_FILE_NAME
        )  #

        self.preprocessor_dir = os.path.join(
            self.data_transformation_dir, PREPROCESSOR_DIR
        )

        self.preprocessor_file_path = os.path.join(
            self.preprocessor_dir, PREPROCESSOR_FILE_NAME
        )  #
