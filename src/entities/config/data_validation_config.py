...
from src.constants.training_pipeline import TEST_FILE_NAME, TRAIN_FILE_NAME
...
class DataValidationConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.valid_data_dir = os.path.join(
            self.data_validation_dir, VALID_DATA_DIR_NAME
        )

        self.invalid_data_dir = os.path.join(
            self.data_validation_dir, INVALID_DATA_DIR_NAME
        )

        self.reports_dir = os.path.join(self.data_validation_dir, REPORT_DIR_NAME)

        self.validation_report_path = os.path.join(
            self.reports_dir, VALIDATION_REPORT_FILE_NAME
        )

        self.drift_report_path = os.path.join(self.reports_dir, DRIFT_REPORT_FILE_NAME)
